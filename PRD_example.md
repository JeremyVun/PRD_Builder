>  [!NOTE]
> This is just an example of a brief / incomplete PRD that I generated from a quick chat. You can continue with this one as your "save point", but I'd recommend starting one from scratch instead (see the instructions in readme.md) to help better capture whatever unique thoughts and vision you might have.
