...
- Another thing that is helpful you can do is open a new chat window, give it your PRD like above and very specifically ask it to `Identify any inconsistencies, uncertainties, and/or failure modes` to shift it from a constructive collaborator to a "devils advocate" persona.
